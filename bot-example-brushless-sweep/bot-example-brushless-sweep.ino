...
// By taking over the timer, the library prevents us using analogWrite 
// on digital pins 9 and 10, however on the up side we can control 
// upto 12 Servos and there are still pins 3,5,6 and 11 to use with 
// analogWrite.  
