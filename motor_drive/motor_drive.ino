/*
  ...
  Connections:
    ...
    Arduino digital output D3 to motor driver input B-IA.
    Arduino digital output D4 to motor driver input B-IB.
...
#define HG7881_A_IA 5 // D3 --> Motor A Input A --> MOTOR B +
#define HG7881_A_IB 6 // D4 --> Motor A Input B --> MOTOR B -
 
// functional connections
#define MOTOR_B_PWM HG7881_B_IA // Motor B PWM Speed
#define MOTOR_B_DIR HG7881_B_IB // Motor B Direction
#define MOTOR_A_PWM HG7881_B_IA // Motor A PWM Speed
#define MOTOR_A_DIR HG7881_B_IB // Motor A Direction
